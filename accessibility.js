...
function applyAccessibility(){
  ...
  const video=document.querySelector('#live-wallpaper-video'); if(video){ if(pause){if(wallpaperPlaybackBeforeA11y===null) wallpaperPlaybackBeforeA11y=!video.paused; video.pause();} else if(wallpaperPlaybackBeforeA11y){video.play().catch(()=>{});wallpaperPlaybackBeforeA11y=null;} video.style.visibility=settings.hideWallpaper?'hidden':''; }
